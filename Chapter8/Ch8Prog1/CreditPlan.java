...
public class CreditPlan
{
    public static void main(String [] args){
        ...
        System.out.printf("%-7s %-15s %-16s %-17s %-10s %s%n", "Month", "Balance Owed", "Interest Owed", "Principal Owed", "Payment", "Money Remaining");
        while (totalOwed2 > 0) {
          month++;
	  ...
	  System.out.printf("%-7d$%-15.2f$%-16.2f$%-17.2f$%-10.2f$%.2f%n", month, totalOwed1, interest, principal, monthly, totalOwed2);
